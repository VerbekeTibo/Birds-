...
DatabaseSeedModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([bird_entity_1.Bird]), nestjs_command_1.CommandModule],
        providers: [seed_command_1.DatabaseSeedCommand, seed_service_1.DatabaseSeedService],
    })
], DatabaseSeedModule);
