...
declare type DecodedIdToken = firebaseAdmin.auth.DecodedIdToken;
export declare type FirebaseAuthDecodedUser = Readonly<Pick<DecodedIdToken, 'uid' | 'email' | 'email_verified'>>;
