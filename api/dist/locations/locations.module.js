...
LocationsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([location_entity_1.Location, observation_entity_1.Observation])],
        providers: [observations_service_1.ObservationsService, locations_resolver_1.LocationsResolver, locations_service_1.LocationsService],
    })
], LocationsModule);
